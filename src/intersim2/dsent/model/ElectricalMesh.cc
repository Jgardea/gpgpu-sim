...
namespace DSENT
{
    ...
    void ElectricalMesh::initParameters()
    {
        ...
        // Physical Parameters
        addParameterName("NumberSites");  // sites are number of nodes jgardea
    ...
    void ElectricalMesh::constructModel()
    {
        ...
        unsigned int number_router_to_router_links = rr_ports * number_routers;
        unsigned int number_router_to_site_links = 2 * number_sites;
        unsigned int router_number_input_ports = rr_ports + number_sites_per_router;
        unsigned int router_number_output_ports = rr_ports + number_sites_per_router;
        ...
        {
            for(unsigned int j = 0; j < rr_ports; ++j)
            {
            ...
            for(unsigned int j = rr_ports; j < router_number_input_ports; ++j)
            {
