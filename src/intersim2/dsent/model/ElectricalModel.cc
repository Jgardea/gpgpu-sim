...
#include "timing_graph/ElectricalDriverMultiplier.h"
...
namespace DSENT
{
    ...
    void ElectricalModel::portConnect(ElectricalModel* connect_model_, const String& connect_port_name_, const String& connect_net_name_, const NetIndex& connect_net_indices_)
    {
        ...
        /*cout << getInstanceName() << endl;                                //jgardea
        cout << "Model: " << connect_model_->getInstanceName() << endl;
        cout << "connect_net_name_ " << connect_net_name_ << endl;
        cout << "connect_port_name_ " << connect_port_name_ << endl;
        cout << "is_input: " << is_input << endl;
        cout << "connect_net_width " << connect_net_width << endl;
        cout << "port inidices[" << port_indices.first << ":" << port_indices.second << "] "<< endl;
        cout << "port width:  " << port_width << endl;
        cout << "connect_net_indeces [" << connect_net_indices_.first <<  ":" << connect_net_indices_.second <<  "]" << endl;*/

        if(is_input)   // connect models with 1 or more indices to another electrical model
        {
            //cout << "Connecting ..." << endl; 
            while(port_index <= port_indices.second)
            {
                //cout << "index: " << port_index;
                //cout << " for Net: " << connect_net_name_ << endl;
                //cout << "Adding downstream node " << connect_port_name_  + "[" + (String) port_index  + "]"  << endl;
    ...
    */
    ...
    void ElectricalModel::assignVirtualFanout(const String& downstream_net_name_, const NetIndex& downstream_net_indices_, const String& upstream_net_name_, const NetIndex& upstream_net_indices_)
    {
        ...
        //cout << "Driver Muliplier Name: " << drive_mult_name << endl;         
        ...
        {
           //cout << "At Index " << i << " Adding downstream node: " << downstream_net_name_ << endl;
    ...
    void ElectricalModel::assignVirtualFanin(const String& downstream_net_name_, const NetIndex& downstream_net_indices_, const String& upstream_net_name_, const NetIndex& upstream_net_indices_)
    {
        ...
        //cout << "upstream_net_name_ " << upstream_net_name_ << endl;
